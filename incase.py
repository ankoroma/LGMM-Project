...
def get_recipe(item, idx):  
        ...
        fat_var = str(int(collection['hits'][idx]['recipe']['totalNutrients']['FAT']['quantity'])) + "g"
        carb_var = str(int(collection['hits'][idx]['recipe']['totalNutrients']['CHOCDF']['quantity'])) + "g"
        protein_var = str(int(collection['hits'][idx]['recipe']['totalNutrients']['PROCNT']['quantity'])) + "g"
        sugar_var = str(int(collection['hits'][idx]['recipe']['totalNutrients']['SUGAR']['quantity'])) + "g"
        sodium_var = str(int(collection['hits'][idx]['recipe']['totalNutrients']['CA']['quantity'])) + "mg"
